...
int main()
{
	...
	/*
	cout << "\nsize of Video is " << sizeof(Video) << endl;
	cout << "size of Frame is " << sizeof(Frame) << endl;
	cout << "size of Vehicle is " << sizeof(Vehicle) << endl;
	cout << "size of VehicleFrameInfo is " << sizeof(VehicleFrameInfo) << endl << endl;
	*/
